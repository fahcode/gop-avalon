/*==================================================
 ...
 avalon.shim.js 1.5.9 built in 2017.2.10
...
//改变Promise的_fired值，并保持用户传参，触发所有回调
    ...
    window.Promise = nativePromise || msPromise
