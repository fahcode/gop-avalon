...
(function(root, factory) {
	...
	var Calendar = function() {
		...
		this.isShow = false;
		this.autohide = true;
		this.toolbarTpl = '<div class="ui-calendar-toolbar clearfix other"><a class="ui-calendar-yj ">长期营业执照</a></div>';
		/*<div class="ui-calendar-toolbar clearfix"><a class="js-calendar-submit">确定</a><a class="js-clear">清空</a><a class="ui-calendar-today">现在</a><a class="ui-calendar-yj">永久</a><a class="ui-calendar-close">关闭</a></div>*/
	...
	Calendar.prototype = {
		...
		getDefaultDate: function() {
			...
			if (this.settings.target && $(this.settings.target).size()) {
				if ($(this.settings.target)[0].nodeType === 1) {
					///判断默认值是否是永久，则为空
					if($(this.settings.target).val() === "永久"){
						this.settings.focusDate = '';
					}else{
		...
		init: function(settings) {
			$('body').append('<div class="ui-calendar clearfix" id="' + this.id + '"><i></i><div class="ui-calendar-pannel clearfix" data-role="pannel"><span class="ui-calendar-control lr-ics" data-role="prev-year">&lt;&lt;</span><span class="ui-calendar-control lr-ic" data-role="prev-month">&lt;</span><span class="ui-calendar-control month" data-role="current-month"></span><span class="ui-calendar-control year" data-role="current-year"></span><span class="ui-calendar-control rl-ic" data-role="next-month">&gt;</span><span class="ui-calendar-control rl-ics" data-role="next-year">&gt;&gt;</span></div><div class="calendar-header clearfix"></div><div class="c_days clearfix"></div></div>');
		...
		bindEvent: function() {
			...
			$('.ui-calendar-toolbar', _this.calendarContainer).delegate('a', 'click', function() {
				...
				//点永久
				if ($(this).hasClass('ui-calendar-yj')) {
					var now = new Date();
					var value = '永久';
					_this.date = now;
					_this.hide();
